...
if(CMAKE_OSX_ARCHITECTURES)
	...
	elseif ("x86_64" IN_LIST CMAKE_OSX_ARCHITECTURES AND "arm64" IN_LIST CMAKE_OSX_ARCHITECTURES)
		set(ARCH_SUFFIX "Universal")
	else()
		set(ARCH_SUFFIX "Unknown")
		message(WARNING "Couldn't determine CMAKE_OSX_ARCHITECTURES")
	endif()
endif()
set(CPACK_PACKAGE_FILE_NAME "Hyperion-${HYPERION_PACKAGE_VERSION}-${CMAKE_SYSTEM_NAME}-${ARCH_SUFFIX}")
