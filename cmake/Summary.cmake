...
if(ENABLE_MDNS AND TARGET qmdns)
    get_target_property(QMDNS_VERSION qmdns QMDNSENGINE_VERSION_PROPERTY)
    if(QMDNS_VERSION)
        message(STATUS "QMdnsEngine version          : ${QMDNS_VERSION}")
    endif()
endif()
if(ENABLE_PROTOBUF_SERVER AND TARGET ProtoBuf)
    get_target_property(PROTOBUF_VERSION ProtoBuf PROTOBUF_VERSION_PROPERTY)
    if(PROTOBUF_VERSION)
...
if(ENABLE_DEV_FTDI AND TARGET libftdi)
    get_target_property(LIBFTDI_VERSION libftdi LIBFTDI_VERSION_PROPERTY)
    if(LIBFTDI_VERSION)
        message(STATUS "LibFTDI version              : ${LIBFTDI_VERSION}")
    endif()
endif()
